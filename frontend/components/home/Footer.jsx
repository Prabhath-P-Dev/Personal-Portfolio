...
const Footer = () => {
    return (
        <>
            ...
            <footer className="flex flex-col bg-gray-900 items-center justify-around w-full py-16 text-sm text-gray-800/70">
                <div className="flex items-center gap-8 mt-4 text-indigo-600">
                ...
                <p className="mt-8 text-center text-xl text-white font-bold hover:text-green-400"> © 2026 Prabhath </p>
            </footer>
            </div>
        </>
    );
